...
class TextRegions(object):
    ...
    pArea = 0.7 #0.60  # area_obj/area_minrect >= 0.6
...
class RendererV3(object):
    ...
    def __init__(self, path_font, data_dir, max_time=None):
        self.text_renderer = tu.RenderFont(path_font, data_dir)
        self.colorizer = Colorize(path_font)
