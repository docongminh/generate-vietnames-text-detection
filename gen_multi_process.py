...
# DATA_PATH = 'data/newsgroup/passport_newgroup.txt'
DATA_PATH = 'data/newsgroup/passport_newgroup.txt'
...
def add_res_to_db(imgname, res, db):
    ...
    for i in range(ninstance):
        ...
        print(">>>>L: ",L)
        print(">>> L: ", [each.decode('utf-8') for each in L])
        db['data'][dname].attrs['txt'] = L


def main(viz, debug, output_masks, data_path, job):
    """
    Entry point.
    ...
    renderer = RendererV3(FONT_PATH, DATA_PATH, max_time=SECS_PER_IMG)
    count = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data", type=str, dest='data_path', default='./background',
